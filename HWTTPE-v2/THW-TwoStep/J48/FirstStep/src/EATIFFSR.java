...
public class EATIFFSR {
	// Extract atemporal instances from file in result folder of first step
	// Word_Offset Word POS Sense_no Gloss Class Prediction_Value EndMarker(##)
