...
cAccuracy=0.0000
i=1
path="/home/dipawesh/Dipawesh/HWTTPE-NEW/THW-TwoStep/MNB/FirstStep"
#-------------------------------Training -----------------------------------------------------------
	java -classpath $path/libsvm.jar:$path/weka.jar weka.classifiers.meta.FilteredClassifier -t $path/ExpandedTrainingSet/TrainSet.arff -x 10 -c last -i -d $path/Models/SVMx10_iteration$i.model -F 'weka.filters.unsupervised.attribute.StringToWordVector -R 1 -W 3000 -N 0 -stemmer weka.core.stemmers.NullStemmer -T -I -M 1 -tokenizer weka.core.tokenizers.WordTokenizer -C'  -W weka.classifiers.functions.LibSVM -- -B >$path/Performance/SVM_x10_iteration$i.txt
...
java -cp $path/src/ExtractTemporalInstancesFromResultOfFirstStep.jar ExtractTemporalInstancesFromResultOfFirstStep $path/Result/ClassifiedFile.txt /home/dipawesh/Dipawesh/HWTTPE-NEW/THW-TwoStep/MNB/SecondStep/TestSet/ /home/dipawesh/Dipawesh/HWTTPE-NEW/THW-TwoStep/MNB/SecondStep/TestSet/
...
cAccuracy=0.0000
i=1
path="/home/dipawesh/Dipawesh/HWTTPE-NEW/THW-TwoStep/MNB/SecondStep"
#-------------------------------Training -----------------------------------------------------------
	java -classpath $path/libsvm.jar:$path/weka.jar weka.classifiers.meta.FilteredClassifier -t $path/ExpandedTrainingSet/TrainSet.arff -x 10 -c last -i -d $path/Models/SVMx10_iteration$i.model -F 'weka.filters.unsupervised.attribute.StringToWordVector -R 1 -W 3000 -N 0 -stemmer weka.core.stemmers.NullStemmer -T -I -M 1 -tokenizer weka.core.tokenizers.WordTokenizer -C'  -W weka.classifiers.functions.LibSVM -- -B >$path/Performance/SVM_x10_iteration$i.txt
	echo 'iteration' $i 'Training over'
	pAccuracy=$(java -cp $path/src/AccuracyFinder.jar AccuracyFinder $path/Performance/SVM_x10_iteration$i.txt)
...
java -cp /home/dipawesh/Dipawesh/HWTTPE-NEW/THW-TwoStep/MNB/FirstStep/src/EATIFFSR.jar EATIFFSR /home/dipawesh/Dipawesh/HWTTPE-NEW/THW-TwoStep/MNB/FirstStep/Result/ClassifiedFile.txt /home/dipawesh/Dipawesh/HWTTPE-NEW/THW-TwoStep/MNB/SecondStep/Result/ClassifiedFile.txt /home/dipawesh/Dipawesh/HWTTPE-NEW/THW-TwoStep/MNB/THW.txt
echo 'result from first & second Step(Final THW) are merged'
#---------------------------------Sentence Classification v1---------------------------------------------------------------------
#java -cp $path/src/SentenceClassificationv1.jar SentenceClassificationv1 $path/GoldStandardTestSet/SensetaggedFileForSentenceClassification.txt /home/dipawesh/MNB/THW.txt $path/Performance/SentenceClassificationEvaluationDetails\(v1\).txt $path/Performance/PerformanceOfSentenceClassificationV1.txt
#echo 'Done with Sentence Classification v1'
#--------------------------------produce evaluation file Sentence Classification v2-----------------------------
#java -cp $path/src/SentenceClassificationReplacingTemporalWordsWithGlossesv2.jar SentenceClassificationReplacingTemporalWordsWithGlossesv2 $path/GoldStandardTestSet/SensetaggedFileForSentenceClassification.txt /home/dipawesh/MNB/THW.txt $path/GoldStandardTestSet/SentenseClassificationV2EvaluationFile.arff
