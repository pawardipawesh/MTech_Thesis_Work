...
java -cp $path/src/ExtractTemporalInstancesFromResultOfFirstStep.jar ExtractTemporalInstancesFromResultOfFirstStep $path/Result/ClassifiedFile.txt /home/dipawesh/THW-TwoStep/MNB/SecondStep/TestSet/ /home/dipawesh/THW-TwoStep/MNB/SecondStep/TestSet/  /home/dipawesh/THW-TwoStep/MNB/SecondStep/TrainingSet/TrainSetWE.arff $path/FullTestSet/TestSetWE.arff
echo 'Extracted Temporal instances from result of first step'
scp -r /home/dipawesh/THW-TwoStep/MNB/SecondStep/TestSet/* /home/dipawesh/THW-TwoStep/MNB/SecondStep/FullTestSet/
...
cAccuracy=0.0000
i=1
path="/home/dipawesh/THW-TwoStep/MNB/SecondStep"
#-------------------------------Training -----------------------------------------------------------
	java -classpath $path/libsvm.jar:$path/weka.jar weka.classifiers.meta.FilteredClassifier -t $path/ExpandedTrainingSet/TrainSetWE.arff -x 10 -i  -c 202 -d $path/Models/SVMx10_iteration$i.model -F 'weka.filters.unsupervised.attribute.StringToWordVector -R first -W 1000 -N 0 -stemmer weka.core.stemmers.NullStemmer -T -I -M 1 -tokenizer weka.core.tokenizers.WordTokenizer -C' -W weka.classifiers.bayes.NaiveBayes -- -K -O >$path/Performance/SVM_x10_iteration$i.txt
	echo 'iteration' $i 'Training over'
	pAccuracy=$(java -cp $path/src/AccuracyFinder.jar AccuracyFinder $path/Performance/SVM_x10_iteration$i.txt)
...
java -cp $path/src/MergeResultsOfFirstAndSecondStep.jar MergeResultsOfFirstAndSecondStep /home/dipawesh/THW-TwoStep/MNB/FirstStep/Result/ClassifiedFile.txt $path/Result/ClassifiedFile.txt /home/dipawesh/THW-TwoStep/MNB/THW.txt
