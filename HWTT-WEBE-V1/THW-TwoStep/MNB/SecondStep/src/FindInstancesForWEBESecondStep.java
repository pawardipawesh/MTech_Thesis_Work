...
public class FindInstancesForWEBESecondStep {
	...
	public static void main(String args[])throws Exception{
		...
		int nopi=0,nopri=0,nofi=0,noni=0;
		ArrayList<TestInstancesInfo> trainseedl=null;
		FindInstancesForWEBESecondStep fi=new FindInstancesForWEBESecondStep();
			try{
			...
			try{
				...
				int noofpastinstancesadded=0,noofpresentinstancesadded=0,nooffutureinstancesadded=0,noofneutralinstancesadded=0;
				expndetails.write("IterationNo\tWord\tWord_Offset\tPOS\tSenseno\tGloss\tPredictedtense\tSimilarity\n");
				 while (iterator.hasNext()) {
					...
					if((noofpastinstancesadded<(25*nopi/100)||noofpresentinstancesadded<(25*nopri/100)||nooffutureinstancesadded<(25*nofi/100)
							||noofneutralinstancesadded<(25*noni/100))){
